/*
DarkMode.ahk — Dark mode GUI framework for AutoHotkey v2.1-alpha.30+
...
Struct SCROLLINFO {
    cbSize: UInt32, fMask: UInt32, nMin: Int32, nMax: Int32
    nPage: UInt32, nPos: Int32, nTrackPos: Int32
}

Struct TRACKMOUSEEVENT {
    cbSize: UInt32, dwFlags: UInt32, hwndTrack: IntPtr, dwHoverTime: UInt32
}
...
Struct TEXTMETRICW {
    tmHeight: Int32, tmAscent: Int32, tmDescent: Int32
    tmInternalLeading: Int32, tmExternalLeading: Int32
    tmAveCharWidth: Int32, tmMaxCharWidth: Int32
    tmWeight: Int32, tmOverhang: Int32
    tmDigitizedAspectX: Int32, tmDigitizedAspectY: Int32
    tmFirstChar: UInt16, tmLastChar: UInt16
    tmDefaultChar: UInt16, tmBreakChar: UInt16
    tmItalic: UInt8, tmUnderlined: UInt8, tmStruckOut: UInt8
    tmPitchAndFamily: UInt8, tmCharSet: UInt8
}

Struct TCITEMW {
    mask: UInt32, dwState: UInt32, dwStateMask: UInt32
    pszText: IntPtr, cchTextMax: Int32
    iImage: Int32, lParam: IntPtr
}

Struct HDITEMW {
    mask: UInt32, cxy: Int32, pszText: IntPtr, hbm: IntPtr
    cchTextMax: Int32, fmt: Int32, lParam: IntPtr
    iImage: Int32, iOrder: Int32, type: UInt32
    pvFilter: IntPtr, state: UInt32
}

Struct MENUINFO {
    cbSize: UInt32, fMask: UInt32, dwStyle: UInt32, cyMax: UInt32
    hbrBack: IntPtr, dwContextHelpID: UInt32, dwMenuData: IntPtr
}
...
Struct Palette {
    Background: UInt32, Surface: UInt32, Header: UInt32, Elevated: UInt32
    Border: UInt32, BorderSubtle: UInt32, BorderHover: UInt32
    Accent: UInt32, AccentHover: UInt32, AccentPressed: UInt32
    Success: UInt32, Warning: UInt32, Error: UInt32, Info: UInt32
    TextPrimary: UInt32, TextSecondary: UInt32, TextMuted: UInt32, TextDisabled: UInt32
    Control: UInt32, ControlHover: UInt32, ControlActive: UInt32, Selection: UInt32
    ScrollTrack: UInt32, ScrollThumb: UInt32, ScrollThumbHover: UInt32
}
