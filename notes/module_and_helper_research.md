...
- `scripts/v2/tests/ImportArrayHelpersExample.ahk` focuses on ArrayHelpers alone, showing both module-object calls and selective imports wired to aliases while verifying the prototype-backed helpers.
