...
#define T_AHK_NAME _T(AHK_NAME)
	...
	#define RAW_AHK_VERSION "2.1-alpha.31+Console"
#endif
#ifdef RC_INVOKED
	#define AHK_VERSION RAW_AHK_VERSION
	#ifndef AHK_VERSION_N
	#define AHK_VERSION_N 2,1,0,31
	#endif
#else
	...
	extern LPCTSTR T_AHK_BUILD_REVISION;
	extern LPCTSTR T_AHK_BUILD_COMPILER;
	extern LPCTSTR T_AHK_BUILD_ARCH;
#endif
